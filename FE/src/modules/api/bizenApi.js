...
export const bizenApi = {
  ...
  platformCompanies: () => apiClient.get("/tenants/companies"),
  ...
  currentCompany: () => apiClient.get("/companies/current"),
  ...
  directChatPeers: () => apiClient.get("/community/direct/peers"),
  directMessages: (peerUserId, limit = 80) => apiClient.get(`/community/direct/messages?peerUserId=${encodeURIComponent(peerUserId)}&limit=${encodeURIComponent(limit)}`),
  sendDirectMessage: (recipientUserId, body) => apiClient.post("/community/direct/messages", { recipientUserId, body }),
  directTyping: (peerUserId) => apiClient.get(`/community/direct/typing?peerUserId=${encodeURIComponent(peerUserId)}`),
  updateDirectTyping: (recipientUserId, isTyping) => apiClient.post("/community/direct/typing", { recipientUserId, isTyping }),
  ...
  createShift: (payload) => apiClient.post("/shifts", payload),
  updateShift: (id, payload) => apiClient.patch(`/shifts/${id}`, payload),
  ...
  subscribePushNotifications: (subscription) => apiClient.post("/notifications/push/subscribe", { subscription }),
  unsubscribePushNotifications: (endpoint) => apiClient.post("/notifications/push/unsubscribe", { endpoint }),
