  ...
  return (
    <div>
      <PageHeader
        ...
        description="Chatbox đọc dữ liệu Neon và stream phản hồi qua Gemini 2.5 Flash; nếu provider hết quota hoặc lỗi tạm thời, hệ thống báo rõ trạng thái và chuyển sang fallback nội bộ."
      />
