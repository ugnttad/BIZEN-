...
const statusStyles = {
  ...
  KpiPending: "bg-amber-50 text-amber-700 ring-amber-100",
  InProgress: "bg-blue-50 text-blue-700 ring-blue-100",
  Submitted: "bg-indigo-50 text-indigo-700 ring-indigo-100",
  Rejected: "bg-rose-50 text-rose-700 ring-rose-100",
  Missed: "bg-rose-50 text-rose-700 ring-rose-100",
  OnTime: "bg-emerald-50 text-emerald-700 ring-emerald-100",
